...
Dept.initColumn = function () {
	var columns = [
		...
		{title: '上级机构', field: 'parentDeptName', align: 'center', valign: 'middle', sortable: true, width: '180px'},
		{title: '机构名称', field: 'deptName', align: 'center', valign: 'middle', sortable: true, width: '180px'},
		{
