package com.ltsznh.modules.gen.utils;


import com.ltsznh.common.exception.FamilyException;
import com.ltsznh.common.utils.DateUtils;
import com.ltsznh.modules.gen.entity.ColumnEntity;
import com.ltsznh.modules.gen.entity.TableEntity;
...
public class GenUtils {
	...
	public static void generatorCode(Map<String, String> table,
		...
		for (String template : templates) {
			...
			try {
				...
				throw new FamilyException("渲染模板失败，表名：" + tableEntity.getTableName(), e);
			}
		}
	}
	...
	public static Configuration getConfig() {
		try {
			...
			throw new FamilyException("获取配置文件失败，", e);
		}
	}
