...
import com.ltsznh.modules.sys.dao.SysUserDao;
...
public class SysUserServiceImpl implements SysUserService {
	...
	@Override
	public SysUserEntity queryByPhone(long phone) {
	...
	@Override
	@Transactional
	public void deleteBatch(Long[] userId,Long modifierId) {
		sysUserDao.deleteBatch(userId,modifierId);
	}
